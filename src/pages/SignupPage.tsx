  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground text-center mb-6">Start clipping in seconds</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <Label htmlFor="name" className="text-muted-foreground text-xs">Name</Label>
            <Input id="name" value={name} onChange={e => setName(e.target.value)} required className="mt-1 bg-secondary border-border" placeholder="John Doe" />
          </div>
          <div>
